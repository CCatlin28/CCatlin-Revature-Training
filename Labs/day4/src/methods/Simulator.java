...
public class Simulator {
	public static void main(String[] args) {
		 ...
		 * When you declare a method, the list of placeholder
		 * variables you can use are known as 'paramaters'
		 * When invoking a method, the data that you supply
		 * to the method (which must match the datatype of the 
		...
		System.out.println("My Account has: $" + accTwo.viewTotal());
	}
}
