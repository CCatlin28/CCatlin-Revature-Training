...
public class Binary {
	public static void main(String[] args) {
		...
		before 2 is added to 5 (order matters)
		*/
		 System.out.println("Hello There: " + 5 + 2); //if add () around the 5+2 then would get 7
		 ...
		 double result2 = 9/2; //when dividing with int, we return an int
